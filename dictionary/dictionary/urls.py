...
urlpatterns = [
    ...
    path('<int:pk_dict>/words/update/<int:pk>', views.WordUpdateView.as_view(), name='update-word-view'),
    path('<int:pk_dict>/words/update/<int:pk_word>/texts/', views.WordTextListView.as_view(), name='update-word-texts-view'),
